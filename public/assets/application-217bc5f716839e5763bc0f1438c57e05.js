...
(function() {
  var game_on, generate_sequence, getChar, loadAlphabet, num, onGameEnd, onGameReady, options, play, resources_loaded, scene_elem, seq, show_seq_elem, timebar_width, times_to_show, user;
  ...
  onGameEnd = function(acc) {
    ...
    return $.post('/progress_entries.json', {
      nsteps: num,
      result: result.join(" ")
